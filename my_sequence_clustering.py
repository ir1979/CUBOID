...
"""
def optimal_sequence_clustering_basic(data, k):
...
if __name__ == '__main__':
    a = [1,2,3,5,6]
    centers, sizes, final_SSE, size, left = optimal_sequence_clustering_basic(a, 2)
    print(centers, sizes, final_SSE, size, left)

    print()
    b = np.random.random_integers(0,10, size=(10,4))
    centers, sizes, final_SSE, size, left = optimal_sequence_clustering_basic(b, 3)
    print(centers, sizes, final_SSE, size, left)
